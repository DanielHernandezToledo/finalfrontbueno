...
const CarouselProducts = () => {
  ...
  return (
        <div id="myCarouselPoducts" className="carousel slide carousel-products" data-bs-ride="carousel">
            ...
            <div className="arrow">
                <img className="carousel-control-prev" type="button" data-bs-target="#myCarouselPoducts" data-bs-slide="prev" src="./Icon feather-arrow-left-circle.svg"/>
                <img className="carousel-control-next" type="button" data-bs-target="#myCarouselPoducts" data-bs-slide="next" src="./Icon feather-arrow-right-circle.svg"/>
            </div>
        </div>
